...
export default function Blog() {
  const featuredPost = {
    title: 'Bitcoin V1 Network Upgrade: What You Need to Know',
    excerpt: 'The latest Bitcoin V1 protocol update introduces significant improvements to security, scalability, and user experience. Learn about the new features and how they benefit the entire ecosystem.',
    author: 'Bitcoin V1 Team',
    date: '2025-09-08',
    readTime: '8 min read',
  ...
  const recentPosts = [
    {
      ...
      excerpt: 'How the Lightning Network integration makes Bitcoin V1 payments instant and affordable.',
    ...
    },
    {
      ...
      excerpt: 'Updated security recommendations for Bitcoin V1 users in the evolving digital landscape.',
      author: 'Bob Smith',
      date: '2025-09-06',
      readTime: '7 min read',
      category: 'Security',
    ...
    {
      title: 'Developer Spotlight: Building on Bitcoin V1',
      excerpt: 'Meet the developers creating innovative applications on the Bitcoin V1 network.',
      author: 'Carol Davis',
      date: '2025-09-05',
      readTime: '6 min read',
    ...
    },
    {
      ...
      excerpt: 'Analyzing Bitcoin V1 adoption trends and usage patterns around the world.',
      author: 'David Wilson',
      date: '2025-09-04',
    ...
    {
      title: 'Educational Initiative: Bitcoin V1 in Schools',
      excerpt: 'New educational programs bringing Bitcoin V1 knowledge to students worldwide.',
      author: 'Frank Miller',
      date: '2025-09-02',
      readTime: '5 min read',
      category: 'Education',
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Stay updated with the latest Bitcoin V1 developments, insights, and community news.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Subscribe to our newsletter for the latest Bitcoin V1 news and updates
            </p>
