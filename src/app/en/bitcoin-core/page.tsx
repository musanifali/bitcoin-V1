...
export default function BitcoinCore() {
  const features = [
    ...
    },
    {
      ...
      description: 'Help strengthen the Bitcoin V1 network by running a full node'
    },
    {
      icon: Code,
      title: 'Complete Control',
      description: 'Have full control over your Bitcoin V1 transactions and privacy'
    }
  ]
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              The reference implementation of Bitcoin V1. Run a full node and help secure the network.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Create or import a wallet and start sending/receiving Bitcoin V1 transactions.</p>
                </div>
              </div>
            </div>
