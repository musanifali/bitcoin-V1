  ...
  const walletCategories = [
    {
      ...
      wallets: [
        {
          name: 'Bitcoin Holding Mobile',
          description: 'Official Bitcoin Holding mobile wallet with advanced security features',
    ...
    },
    {
      ...
      icon: Shield,
      description: 'The most secure way to store Bitcoin Holding',
      wallets: [
        {
          name: 'ColdSafe Pro',
    ...
    },
    {
      ...
      name: 'Web Wallets',
      icon: Globe,
      description: 'Access your Bitcoin Holding from any web browser',
      wallets: [
        {
          name: 'WebVault',
