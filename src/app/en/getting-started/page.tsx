  ...
  return (
    <main className="min-h-screen bg-background">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto mt-12">
              <a href="#how-to-use" className="bg-card rounded-xl border p-6 hover:border-bitcoin-500/40 transition-colors group">
                ...
                <h3 className="text-xl font-bold mb-2 group-hover:text-bitcoin-600 transition-colors">How to use Bitcoin</h3>
                <p className="text-muted-foreground text-sm">Learn to send, receive and manage Bitcoin</p>
              </a>
              ...
              <a href="#how-to-accept" className="bg-card rounded-xl border p-6 hover:border-bitcoin-500/40 transition-colors group">
                ...
                <h3 className="text-xl font-bold mb-2 group-hover:text-bitcoin-600 transition-colors">How to accept Bitcoin</h3>
                <p className="text-muted-foreground text-sm">Start accepting Bitcoin for your business</p>
              </a>
            </div>
          </div>
        </div>
      ...
      <section id="how-to-use" className="py-16">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold mb-12 text-center">How to use Bitcoin</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-card rounded-xl border p-6 hover:border-bitcoin-500/40 transition-colors">
                ...
                <h3 className="text-xl font-bold mb-4">Get Bitcoin</h3>
                <p className="text-muted-foreground mb-6 text-sm leading-relaxed">
              ...
              <div className="bg-card rounded-xl border p-6 hover:border-bitcoin-500/40 transition-colors">
                ...
                <h3 className="text-xl font-bold mb-4">Spend Bitcoin</h3>
                <p className="text-muted-foreground mb-6 text-sm leading-relaxed">
      ...
      <section id="how-to-accept" className="py-16 bg-muted/20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold mb-12 text-center">How to accept Bitcoin</h2>
