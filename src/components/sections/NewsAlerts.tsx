...
export default function NewsAlerts() {
  const featuredNews = {
    ...
    excerpt: "The latest Bitcoin V1 protocol update introduces advanced security features and significant performance improvements. This major upgrade brings enhanced transaction speeds and improved security protocols.",
    date: "3 hours ago",
  ...
  const trendingNews = [
    {
      ...
      excerpt: "Major milestone achieved in Lightning Network integration with Bitcoin V1",
      category: "Technology",
      time: "1 hour ago",
      views: "1.8k",
      priority: "high"
    ...
    {
      title: "Major Exchange Adds Bitcoin V1 Support",
      excerpt: "Leading cryptocurrency exchange announces full Bitcoin V1 trading support",
      category: "Markets",
      time: "3 hours ago",
      views: "3.2k",
      priority: "high"
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-20 relative">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Get the latest Bitcoin V1 news, security alerts, and network insights in one place
            </p>
          </div>
        </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">Most viewed stories in Bitcoin V1 community</p>
            </div>
        ...
        <div className="text-center bg-gradient-to-r from-bitcoin-500/10 via-orange-500/10 to-red-500/10 rounded-3xl p-12">
          <h3 className="text-3xl font-bold text-foreground mb-4">
            Stay Connected with Bitcoin V1
          </h3>
